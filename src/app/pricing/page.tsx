...
export const metadata: Metadata = {
  title: "Pricing — Fe Exam Premium",
  description: "Unlock unlimited Fe Exam practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=fe-exam&cadence=annual`;
