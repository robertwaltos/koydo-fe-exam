...
const EXAM_ID = "fe-exam";
const EXAM_DISPLAY_NAME = "FE (Fundamentals of Engineering) Exam";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover mathematics, ethics, engineering sciences, and discipline-specific topics (Civil/Mechanical/Electrical/Chemical). Use NCEES FE Reference Handbook conventions.
