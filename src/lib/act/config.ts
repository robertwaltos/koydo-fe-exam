// Auto-generated shim — re-exports from @/lib/fe-exam/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _fe_exam_Config } from "@/lib/fe-exam/config";
import { EXAM_CONFIG as _raw } from "@/lib/fe-exam/config";
